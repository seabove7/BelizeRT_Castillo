...
setwd("/Users/daviessw/Dropbox/UNC/RT_Paper/2020_Final_RT/Sym_GE/Sym_GO")

# Edit these to match your data file names: 
input="trans_sym_NSvsFR_GO.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
