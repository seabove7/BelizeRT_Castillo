...
Overall temperature observations from Nov 2014 - Oct 2015
```{r}
...
temp_plot +
  ...
  annotate("text", x = 3.0, y = 33.0, label = deparse(temp_FN_pval), parse = TRUE, size = 2.5) +
  annotate("text", x = 3.02, y = 32.6, label = deparse(temp_FB_pval), parse = TRUE, size = 2.5) +
  annotate("text", x = 3.0, y = 32.2, label = deparse(temp_NB_pval), parse = TRUE, size = 2.5)
...
week_range_stat_plot <- week_range_plot +
  ...
  annotate("text", x = 3.62, y = 5.4, label = deparse(week_range_FN_pval), parse = TRUE, size = 2.5) +
  annotate("text", x = 3.66, y = 6, label = deparse(week_range_NB_pval), parse = TRUE, size = 2.5) +
  annotate("text", x = 3.62, y = 5.7, label = deparse(week_range_FB_pval), parse = TRUE, size = 2.5) +
  coord_cartesian(x = c(1, 3.6))
...
surv_plot$plot <-  surv_plot$plot + scale_x_continuous(breaks = c(0, 365, 711, 1088, 1445), labels = c("2011", "2012", "2013", "2014", "2015")) +
  ...
  theme(plot.margin = margin(0.1, 0.7, 0.1, 0.1, "cm"))
