...
```{r supplemental calcification plot, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.height=4, fig.width=5}
...
```{r supplementalTP calcification plot, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.height=4, fig.width=9.5}
...
plot_grid(calc.avg.plot, calc.tp.plot, rel_widths = c(0.7,1.3), labels = c("A", "B"), scale = 0.9) +
  ...
  ggsave("/Users/colleen/BelizeRT_CalcSurvData/RT_figures/Figure2_Calcification_modified.pdf", height = 3.3, width = 12, useDingbats = FALSE)
...
plot_grid(calc.avg2.plot, calc.tp2.plot, rel_widths = c(0.7,1.3), labels = c("A", "B"), scale = 0.9) +
  ...
  ggsave("/Users/colleen/BelizeRT_CalcSurvData/RT_figures/FigureS1_Calcification_modified.pdf", height = 3.3, width = 12, useDingbats = FALSE)
