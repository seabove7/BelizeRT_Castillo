...
### Supplemental Table 9A

*(These model outputs are taken from the plasticity analysis and just constructed into tables here)*

**Table S9A.** Linear model output assessing coral host gene expression plasticity. The intercept was set at corals from the backreef transplanted back to the backreef.  (BR = backreef, FR = forereef, NS = Nearshore) 
...
### Supplemental Table 9B

*(These model outputs are taken from the plasticity analysis and just constructed into tables here)*

**Table SB.** Linear model output assessing algal symbiont gene expression plasticity. The intercept was set at corals from the backreef transplanted back to the backreef.  (BR = backreef, FR = forereef, NS = Nearshore) 
