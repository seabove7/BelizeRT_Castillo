...
tableS6 <- summary(calc.model)$coefficients

row.names(tableS6) <- c("(Intercept)", "source (FR)", "source (NS)", "transplant (FR)", "transplant (NS)", "source (FR):transplant (FR)", "source (NS):transplant (FR)", "source (FR):transplant (NS)", "source (NS):transplant (NS)")
...
map_png <- readPNG("Figures/Supplemental_Figures/Figure1A_Map.png")
...
fig_1c <- week_range_stat_plot + 
  ...
  ylab("Weekly Temperature \n Range (°C)")

```

```{r full figure 1, fig.height = 8, fig.width = 10}
...
Figure1 <- fig_1a + fig_1b + fig_1c + plot_layout(design = layout) + plot_annotation(tag_levels = 'A')  &
  theme(plot.tag = element_text(size = 20))
Figure1

ggsave("Figures/Figure1_map_temp.pdf", height = 8, width = 10, useDingbats = FALSE) # save plot as PDF
ggsave("Figures/Figure1_map_temp.png", height = 8, width = 10) # save plot as PNG
...
ggsave("Figures/Supplemental_Figures/FigureS1_temps.pdf", height = 8, width = 14, useDingbats = FALSE) # save plot
ggsave("Figures/Supplemental_Figures/FigureS1_temps.png", height = 8, width = 14) # save plot
...
ggsave("Figures/Supplemental_Figures/FigureS2_Calcification.pdf", height = 6, width = 12, useDingbats = FALSE)
ggsave("Figures/Supplemental_Figures/FigureS2_Calcification.png", height = 6, width = 12)
