...
the fraction of shared genes. This simplifies the GO hierarchy, generates biologically 
meaningful groups of categories tailored for the particular dataset, and improves the 
multiple testing situation. The merging extent is controlled by the 'cutTreeHeight' 
parameter in the call to gomwuStats.
